...
import form.MyUserAccountForm;
import mapper.MyUserAccountMapper;
...
public class MyUserAccountDAO extends JdbcDaoSupport{
	...
	public MyUserAccount findById(String id){
		String sql="select id,user_name,first_name,last_name,password,role from User_Accounts u where=?";
